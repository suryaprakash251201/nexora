...
- Current version is tracked in the repo-root `VERSION` file (`1.11.0`) — `web` and `desktop` are synced to it; `mobile` has an independent app-store version. See `CHANGELOG.md`.
