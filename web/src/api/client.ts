...
export const versionsApi = {
   ...
   *  Uses getMediaUrl so Tauri builds pointed at a remote server get the
   *  absolute base URL + bearer query token (a bare relative path resolves
   *  against the tauri:// origin and never reaches the API). */
  downloadUrl: (id: string) => getMediaUrl(`/files/versions/${id}/download`),
};
